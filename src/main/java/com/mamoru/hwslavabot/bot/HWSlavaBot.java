...
//        return replyMessage;
    ...
    private void deleteCarnoEnter(Update update) throws TelegramApiException {
        ...
        if (newChatMembers != null && !newChatMembers.isEmpty()) {
            ...
            if (newChatMembers.get(0).getId().equals(906452258) || newChatMembers.get(0).getId().equals(123616664)) {
            ...
            }else if (message.getFrom().getId().equals(906452258) || message.getFrom().getId().equals(123616664)) {
